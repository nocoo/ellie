// data/repositories/types.ts — Repository interfaces (Contract layer)
// Ref: 04a §Repository Interfaces
// All Mock and API implementations must satisfy these interfaces.
