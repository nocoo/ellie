...
function getStatusMessage(code: string): string {
	const messages: Record<string, string> = {
		...
		ALREADY_PURGED: "User has already been purged",
		CANNOT_PURGE_STAFF: "Staff accounts cannot be purged",
		CONFIRM_MISMATCH: 'Type "ok" to confirm cleanup',
		PURGE_DB_FAILED: "Could not confirm cleanup. Refresh the user status before retrying",
