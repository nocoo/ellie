				...
				<div className="grid gap-4 py-4">
					...
					<div className="grid gap-2">
						...
						<textarea
							...
							placeholder="封禁原因（选填）"
							rows={3}
							className="rounded-md border border-border bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
						/>
					</div>
