...
export function buildGlobalFooterViewModel(settings: SettingsMap): GlobalFooterViewModel {
	return {
		...
		poweredBy: getStr(settings, "general.site.powered_by", "Ellie"),
		version: VERSION_DISPLAY,
		copyrightYears: getStr(settings, "general.site.copyright_years", "2003-2026"),
		copyrightHolder: getStr(settings, "general.site.copyright", "hexly.ai"),
