...
| 4b | `chore(scripts): backfill-email-normalized + find-duplicate-emails` | Tooling only. Run in ops; resolve duplicates. |
| 4c | `feat(db): unique partial index on email_normalized (migration 0029)` | Lands only after 4b reports zero duplicates. |
