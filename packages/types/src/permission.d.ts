...
export declare function canReplyToThread(user: PermissionUser | null, thread: PermissionThread): boolean;
/**
...
export declare function canEditPost(user: PermissionUser | null, post: PermissionPost, forum: PermissionForum): boolean;
/**
 ...
 */
export declare function canDeletePost(user: PermissionUser | null, post: PermissionPost, _forum: PermissionForum): boolean;
/**
 ...
 */
export declare function canDeleteThread(user: PermissionUser | null, thread: {
    authorId: number;
}, _forum: PermissionForum): boolean;
/**
